...
enum {
  ...
  pup_sync_begin =
      pup_sync_builtin + 0x01000000, /* Sync code at start of collection */
  pup_sync_end =
      pup_sync_builtin + 0x02000000, /* Sync code at end of collection */
  ...
  pup_sync_item =
      pup_sync_builtin + 0x00110000, /* Sync code for a list or array item */
  pup_sync_index =
      pup_sync_builtin + 0x00120000, /* Sync code for index of item in a list */
