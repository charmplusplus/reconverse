...
//                         // CMK_DIRECT_API_REVERSE for p2p direct api with
//                         // inverse operation CMK_EM_API for p2p entry method
//                         api
//                         // CMK_EM_API_REVERSE for p2p entry method api with
//                         // inverse operation
...
//   unsigned char
//       freeMe; // CMK_FREE_NCPYOPINFO in order to free NcpyOperationInfo
//               // CMK_DONT_FREE_NCPYOPINFO in order to not free
//               NcpyOperationInfo
...
typedef struct DeviceRdmaInfo_ {
  ...
  void
      *msg; // Charm++ message to be (re-)enqueued after all operations complete
} DeviceRdmaInfo;
